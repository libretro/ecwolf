...
const char* const ControlMenuItem::keyNames[512] =
{
	...
	"?","?","?","?","?","?","?","?",                                // 296
	"?","?","?","?","?","?","?","?",                                // 304
	"?","CpLk","F1","F2","F3","F4","F5","F6",                       // 312
	"F7","F8","F9","F10","F11","F12","PrtS","ScLk",                 // 320
	"Brk","Ins","Home","PgUp","Del","End","PgDn","Rght",            // 328
	"Left","Down","Up","NmLk","Divd","Mult","Mins","Plus",          // 336
	"Entr","KP1","KP2","KP3","KP4","KP5","KP6","KP7",               // 344
	"KP8","KP9","KP0","Perd","?","App","Pwr","Equl",                // 352
	"F13","F14","F15","F16","F17","F18","F19","F20",                // 360
	"F21","F22","F23","F24","?","Help","Menu","?"                   // 368
	"Stop","Redo","Undo","Cut","Copy","Pst","Find","Mute",          // 376
	"VlUp","VlDn","?","?","?","KP,","?","?",                        // 384
	"?","?","?","?","?","?","?","?",                                // 392
	"?","?","?","?","?","?","?","?",                                // 400
	"?","?","?","?","?","?","?","?",                                // 408
	...
	"?","?","?","?","?","?","?","?",                                // 464
	"?","?","?","?","?","?","?","?",                                // 472
	"?","Ctrl","Shft","Alt","Meta","RCtl","RShf","RAlt","RMet"      // 480
#endif
};
...
void ControlMenuItem::draw()
{
	...
	if(button.keyboard >= 0 && button.keyboard < 512 && keyNames[button.keyboard])
	{
		PrintX = 162;
